...
const getAuthUrl = function(state, redirect_url, scope){
	return new Promise(function(reslove,reject){
		...
		let url = `https://e.dianping.com/dz-open/merchant/auth?app_key=${appkey}&redirect_url=${redirect_url}`;
		if(scope){
...
*/
const getAuthorizerAccessToken = function(auth_code){
	return new Promise(function(reslove,reject){
		if(!auth_code){
...
const routerOauthSessionScope = function(session, params){
	return new Promise(function(reslove,reject){
		...
		var options = {
			url:apiUrl.routerOauthSessionScopeUrl,
			method:"post",
